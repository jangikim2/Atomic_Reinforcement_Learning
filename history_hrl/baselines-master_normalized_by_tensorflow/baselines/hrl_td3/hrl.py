...
class hrlTD3():
    ...
    def update_meta_controller(self, o, ag, g, o_new, high_goal_gt_tilda, r, d,  episode_timesteps):
        ...
        self.meta_controller.train(self.uo_stats, self.high_replay_buffer, episode_timesteps, self.hrl_batch_size, self.discount, self.tau, self.policy_noise,
    ...
    def update_controller(self, o, o_new, high_goal_gt, u, r, d, episode_timesteps):
        ...
        #x, y, u, r, d = self.low_replay_buffer.sample(self.hrl_batch_size)

        #t_o = self.o_stats.normalize(tf.convert_to_tensor(x))
        #n_o = t_o.eval()
