...
dtype = torch.cuda.FloatTensor if torch.cuda.is_available() else torch.FloatTensor #jangikim
...
class TD3(object):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.actor_target = Actor().type(dtype)
        ##############
        ...
        self.critic_target = Critic().type(dtype)
        ##############
